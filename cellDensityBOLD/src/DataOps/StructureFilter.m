...
case {'cortical','cortex'}
    ...
    %------------- Include other divisions in the cortex (BH) -------------
    isCortex = isCortex | strcmp(structInfo.divisionLabel,'Olfactory Areas');
    isCortex = isCortex | strcmp(structInfo.divisionLabel,'Hippocampal Formation');
    isCortex = isCortex | strcmp(structInfo.divisionLabel,'Cortical Subplate');
    structInfoFilt = structInfo(isCortex,:);
    ix = isCortex;
case 'isocortex'
    isoCortex = strcmp(structInfo.divisionLabel,'Isocortex');
    structInfoFilt = structInfo(isoCortex,:);
    ix = isoCortex;
    %----------------------------------------------------------------------
