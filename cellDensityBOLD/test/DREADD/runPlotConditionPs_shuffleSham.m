...
nullFile_hctsaExc = '../Data/Results/DREADDnulls/densityShuffleShamNulls_hctsaExc_v1.mat';
nullFile_hctsaPV = '../Data/Results/DREADDnulls/densityShuffleShamNulls_hctsaPV_v1.mat';
...
plotConditionPs(dataDREADD, dataDensity, 'all\locdep', [], [],...
    {{nullFile_hctsaExc, nullFile_hctsaPV}, {nullFile_hctsaExc, nullFile_hctsaPV}}, {'Excitatory', 'PV'}, doSig)
title('hctsa\\locdep')
