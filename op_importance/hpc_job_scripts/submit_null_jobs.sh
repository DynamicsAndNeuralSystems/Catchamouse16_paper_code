...
declare -a longerTasks=("CBF" "ChlorineConcentration" "Cricket_X" "Cricket_Y" "Cricket_Z" "ECG5000" "ElectricDevices" "FordA" "FordB" "NonInvasiveFatalECG_Thorax1" "NonInvasiveFatalECG_Thorax2" "StarLightCurves" "Two_Patterns" "UWaveGestureLibraryAll" "uWaveGestureLibrary_X" "uWaveGestureLibrary_Y" "uWaveGestureLibrary_Z" "wafer")
