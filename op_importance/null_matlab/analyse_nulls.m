...
null_folder = '../data/intermediate_results_maxmin_null/';
legit_folder = '../data/intermediate_results_scaledrobustsigmoid/';
...
for i = 1:length(task_names)
    ...
    null = load(['../data/intermediate_results_null_scaledrobustsigmoid/task_',task_names{i},'_tot_stats.txt']);
    legit = load(['../data/intermediate_results_scaledrobustsigmoid/task_',task_names{i},'_tot_stats.txt']);
