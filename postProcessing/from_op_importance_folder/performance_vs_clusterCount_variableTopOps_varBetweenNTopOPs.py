...
meanMeanMean = np.mean(meanMeanArray, axis=1)
stdMeanMean = np.std(meanMeanArray, axis=1)
...
ax1.set_ylabel('mean error on 93 datasets +/- std over different # top ops', color='b')
